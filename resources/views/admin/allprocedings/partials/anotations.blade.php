                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row mb-4">
                                    ...
                                    <div class="form-group-sm col-md-6">
                                        <label class="col-form-label col-form-label-sm" for="foly">Fecha de
                                            Envío</label>
                                        <input type="text" class="form-control form-control-sm"
                                ...
                                <div class="form-row mb-4">
                                    ...
                                    <div class="form-group-sm col-md-6">
                                        ...
                                        @if ($respuesta->read_status == 1)
                                            <input type="text" class="form-control form-control-sm" value="Si"
                                                readonly>
                                        @else
                                            <input type="text" class="form-control form-control-sm" value="No"
                                                readonly>
                                        @endif
                                    </div>
