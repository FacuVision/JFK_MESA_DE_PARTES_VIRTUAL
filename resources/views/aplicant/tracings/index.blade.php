                                            ...
                                            <div class="px-4 py-5 bg-white sm:p-6">
                                                ...
                                                <table id="horarios" class="table table-hover min-w-full divide-y divide-gray-200" style="width:100%">
                                                   ...
                                                   <tr style="font-size: 0.9em">
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap">{{$pro->code}}</td>
                                                            <td class="px-6 py-4 whitespace-nowrap">{{$pro->title}}</td>
                                                            <td class="px-6 py-4 whitespace-nowrap">{{$pro->n_foly}}</td>
                                                            <td class="px-6 py-4 whitespace-nowrap">{{$pro->reference}}</td>
                                                            @switch($pro->status)
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap">{{$pro->office->name}}</td>
                                                            <td class="px-6 py-4 whitespace-nowrap">{{$pro->type_proceding->name}}</td>
                                                            <td class="px-6 py-4 whitespace-nowrap">
                                                                <a href="{{ route('aplicants.tracings.show', $pro)}}"
                                                                ...
                                                                {{-- <a href="#" data-toggle="modal" data-target="#showModal{{ $pro->id }}"
