<x-app-layout>
                                                    ...
                                                    @foreach ($procedings as $proceding)
                                                        <tr>
                                                            ...
                                                            @switch($proceding->status)
                                                                @case(1)
                                                                    <td class="px-6 py-4 whitespace-nowrap"
                                                                        style="color:green; font-weight: bold">Enviado</td>
                                                                @break

                                                                @case(2)
                                                                    <td class="px-6 py-4 whitespace-nowrap"
                                                                        style="color:indigo; font-weight: bold">Derivado</td>
                                                                @break

                                                                @case(3)
                                                                    <td class="px-6 py-4 whitespace-nowrap"
                                                                        style="color:crimson; font-weight: bold">Por subsanar
                                                                    </td>
                                                                @break

                                                                @case(4)
                                                                    <td class="px-6 py-4 whitespace-nowrap"
                                                                        style="color:gray; font-weight: bold">Archivado</td>
                                                                @break

                                                                @case(5)
                                                                    <td class="px-6 py-4 whitespace-nowrap"
                                                                        style="color:black; font-weight: bold">Rechazado</td>
                                                                @break

                                                                @case(6)
                                                                    <td class="px-6 py-4 whitespace-nowrap"
                                                                        style="color:orange; font-weight: bold">Subsanado</td>
                                                                @break

                                                                @case(7)
                                                                    <td class="px-6 py-4 whitespace-nowrap"
                                                                        style="color:blue; font-weight: bold">Desarchivado</td>
                                                                @break
                                                            @endswitch
                                                            ...
                                                            <td class="px-6 py-4 whitespace-nowrap">
                                                                ...
                                                                <a href="#" data-toggle="modal"
                                                                    data-target="#showModal{{ $proceding->id }}"
                                                                ...
                                                                @if ($proceding->answers->count() > 0)
                                                                    <a href="#" data-toggle="modal" id="visto"
                                                                        onclick="visto('{{ $proceding->id }}')"
    ...
    <script>
        ...
        function visto(res) {
            $.ajax({
                type: 'POST',
                url: "{{ route('aplicants.tracings.store') }}",
                data: {
                    id: res,
                    _token: '{{ csrf_token() }}'
                },
