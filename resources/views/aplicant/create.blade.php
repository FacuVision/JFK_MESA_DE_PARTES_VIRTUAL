                                            ...
                                            <div class="px-4 py-5 bg-white sm:p-6">
                                                <div class="grid grid-cols-6 gap-6">
                                                    ...
                                                    <div class="col-span-6 sm:col-span-4">
                                                        <label for="email-address" class="block text-sm font-medium text-gray-700">Oficina a donde desea dirigirse (*)</label>
                                                        ...
                                                        <div class="mt-1 leading-normal text-red-600 border border-red-600 rounded-lg" role="alert">
                                                    ...
                                                    <div class="col-span-6 sm:col-span-4">
                                                        ...
                                                        <div class="mt-1">
                                                            ...
                                                            <textarea id="content" name="content" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Ingrese una descripción" ></textarea>
                                                        </div>
                                                        @error('content')
                                                    ...
                                                    <div class="col-span-6 sm:col-span-3">
                                                        ...
                                                        <input type="text" name="n_foly" id="n_foly" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" >
                                                        @error('n_foly')
