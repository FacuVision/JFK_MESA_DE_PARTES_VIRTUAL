            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-6 text-gray-500">
                        Tramita tus documentos de manera virtual, rapida y sencilla.
                    </div>
                </div>
                ...
                <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a
                                    href="#">JFK Escuela de Manejo</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-sm text-gray-500">
                                Formamos profesionales de la conducción vehicular comprometidos con la seguridad vial.
