...
class SiteSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::insert("INSERT INTO departaments (id, name) VALUES
        (1, 'AMAZONAS'),
        (2, 'ANCASH'),
        (3, 'APURIMAC'),
        (4, 'AREQUIPA'),
        ...
        DB::insert("INSERT INTO provinces (id, name , departament_id) values
        (1, 'CHACHAPOYAS ', 1),
        (2, 'BAGUA', 1),
        (3, 'BONGARA', 1),
        (4, 'CONDORCANQUI', 1),
        ...
        DB::insert("INSERT INTO districts (id, name, province_id) values
        (1, 'CHACHAPOYAS', 1),
        (2, 'ASUNCION', 1),
        (3, 'BALSAS', 1),
        (4, 'CHETO', 1),
